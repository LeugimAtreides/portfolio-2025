...
if not DEBUG:
    ...
    # Object Ownership often disables ACLs; use a bucket policy for public GetObject instead.
    AWS_DEFAULT_ACL = None
    AWS_S3_OBJECT_PARAMETERS = {
        "CacheControl": "max-age=86400",
    }
    # Stable public URLs for <img src="..."> when the bucket allows anonymous read (see bucket policy).
    ...
    # Django 5.x: explicit default storage (DEFAULT_FILE_STORAGE alone can be ignored)
    STORAGES = {
        "default": {
